''
  /* Zenburn (base16), matching stylix's base16Scheme */
  @define-color rosewater #dfaf8f;
  @define-color flamingo #dfaf8f;
  @define-color pink #dc8cc3;
  @define-color mauve #dc8cc3;
  @define-color red #dca3a3;
  @define-color maroon #dca3a3;
  @define-color peach #dfaf8f;
  @define-color yellow #e0cf9f;
  @define-color green #5f7f5f;
  @define-color teal #93e0e3;
  @define-color sky #93e0e3;
  @define-color sapphire #7cb8bb;
  @define-color blue #7cb8bb;
  @define-color lavender #dc8cc3;
  @define-color orange #dfaf8f;
  @define-color white #ffffff;
  @define-color text #dcdccc;
  @define-color subtext1 #dcdccc;
  @define-color subtext0 #808080;
  @define-color overlay2 #808080;
  @define-color overlay1 #808080;
  @define-color overlay0 #6f6f6f;
  @define-color surface2 #6f6f6f;
  @define-color surface1 #606060;
  @define-color surface0 #606060;
  @define-color base #404040;
  @define-color mantle #383838;
  @define-color crust #2d2d2d;
